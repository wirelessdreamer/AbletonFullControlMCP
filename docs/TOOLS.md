...
**196 tools** across **25 categories**.
...
- [Sound modeling (sound_*)](#sound-modeling-sound_) — 7 tools
...
| `midi_note` | `integer | null` | no | None |
| `velocity` | `integer` | no | 100 |
...
| Name | Type | Required | Default |
|------|------|----------|---------|
| `backend` | `string | null` | no | None |
| `tape_host` | `string | null` | no | None |
| `tape_send_port` | `integer | null` | no | None |
| `tape_recv_port` | `integer | null` | no | None |
| `tape_timeout` | `number | null` | no | None |
| `loopback_device` | `string | null` | no | None |
| `sample_rate` | `integer | null` | no | None |
