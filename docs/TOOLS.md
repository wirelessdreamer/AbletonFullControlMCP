...
**245 tools** across **31 categories**.
...
| `out_path` | `string` | no | 'D:\\Code\\AbletonFullControlMCP\\data\\inventory\\manifest.json' |
| `dry_run` | `boolean` | no | False |
...
| `direction` | `string` | no | 'auto' |
| `output_path` | `string | null` | no | None |
| `duration_sec` | `number | null` | no | None |
| `background` | `boolean` | no | False |
